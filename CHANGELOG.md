...
- [#10607: ビルド周りを最新化する](https://redmine.u6k.me/issues/10607)

### Added

- [#10608: スクレイピング時にtimestampを付与する](https://redmine.u6k.me/issues/10608)
- [#10556: メッセージ駆動でクロールする](https://redmine.u6k.me/issues/10556)
...
- [#10231: ビルドプロセスを最新化する](https://redmine.u6k.me/issues/10231)

## [2.1.0] - 2022-08-23

### Added

- [#9689: tor経由でクロールする](https://redmine.u6k.me/issues/9689)

## [2.0.0] - 2022-08-20

### Added

- [#9608: クロール結果をDB直接参照しないように、アプリケーション間はAPI分離する](https://redmine.u6k.me/issues/9608)

## [1.8.1] - 2022-07-16

### Fixed

- [#9596: KaisaiRaceListページがクロールできない](https://redmine.u6k.me/issues/9596)

### Added

- [#9590: 年月日ページを指定してクロールできるようにする](https://redmine.u6k.me/issues/9590)
